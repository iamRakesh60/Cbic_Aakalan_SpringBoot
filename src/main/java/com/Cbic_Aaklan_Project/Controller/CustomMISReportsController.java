...
//                resultMap.put(zoneCode, new CustomMISReports(zoneName, zoneCode, null, 0.00, finalFormattedDate, "Timely payment of Refunds"));
//            }
//        });
...
//            if (!resultMap.containsKey(zoneCode)) {
//                String zoneName = customMISReportsService.getZoneName(zoneCode);
//                resultMap.put(zoneCode, new CustomMISReports(zoneName, zoneCode, null, 0.00, finalFormattedDate, "Adjudication"));
//            }
//        });
//        // Return the list sorted by zone_code
//        return resultMap.values().stream()
...
//            if (!resultMap.containsKey(zoneCode)) {
//                String zoneName = customMISReportsService.getZoneName(zoneCode);
//                resultMap.put(zoneCode, new CustomMISReports(zoneName, zoneCode, null, 0.00, finalFormattedDate, "Commissioner (Appeals)"));
//            }
//        });
//        // Return the list sorted by zone_code
//        return resultMap.values().stream()
