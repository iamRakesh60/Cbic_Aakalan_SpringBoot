...
public class CustomParameter implements Serializable {
    ...
    public CustomParameter(String zoneName, String commName, String zone_code, Double totalScore, String absval, Integer zonal_rank, String custom, String ra, Integer way_to_grade, Integer insentavization, Double parameter_wise_weighted_average, Double sub_parameter_weighted_average) {
