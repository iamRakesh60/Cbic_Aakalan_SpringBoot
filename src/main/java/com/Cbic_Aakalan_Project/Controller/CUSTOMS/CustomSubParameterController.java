        ...
        try (Connection con = JDBCConnection.getTNConnection()){
            if("zone".equalsIgnoreCase(type)) {
                ...
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    ...
                    pstmt.setString(2, month_date);
                    ResultSet rsGst14aa = pstmt.executeQuery();
                    allGstaList.addAll(customSubParameterService.cus12bZone(rsGst14aa));
                }
                ...
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    ...
                    pstmt.setString(4, zone_code);
                    ResultSet rsGst14aa = pstmt.executeQuery();
                    allGstaList.addAll(customSubParameterService.cus12bZoneWiseCommissionary(rsGst14aa));
                }
                ...
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    ...
                    pstmt.setString(2, month_date);
                    ResultSet rsGst14aa = pstmt.executeQuery();
                    allGstaList.addAll(customSubParameterService.cus12bAllCommissionary(rsGst14aa));
                }
            }
        } catch (SQLException e) {
            e.printStackTrace();
