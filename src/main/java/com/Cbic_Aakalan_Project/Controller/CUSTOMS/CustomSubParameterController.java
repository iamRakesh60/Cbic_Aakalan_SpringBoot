...
public class CustomSubParameterController {
    ...
    public Object Custom2a(@RequestParam String month_date,@RequestParam String type, @RequestParam(required = false) String zone_code){
        ...
        try {
            ...
            if (type.equalsIgnoreCase("zone")) {
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2a_ZoneWise(month_date);
                ...
                System.out.println("cus 2a median zone wise :- "+median);

            } else if (type.equalsIgnoreCase("commissary")) {  // cus2a
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2a_CommissonaryWise(month_date,zone_code);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2a_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
                ...
                System.out.println("cus 2a median commi wise :- "+median);
            }else if (type.equalsIgnoreCase("all_commissary")) {  // cus9a
                //              '" + month_date + "'	 '" + prev_month_new + "'	'" + zone_code + "'		'" + come_name + "' 	'" + next_month_new + "'
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2a_AllCommissonaryWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2a_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
    ...
    public Object Custom2b(@RequestParam String month_date,@RequestParam String type, @RequestParam(required = false) String zone_code){
        ...
        try {
            ...
            if (type.equalsIgnoreCase("zone")) {
                //              '" + month_date + "'	 '" + prev_month_new + "'	'" + zone_code + "'		'" + come_name + "' 	'" + next_month_new + "'
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2b_ZoneWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                ...
                System.out.println("cus 2b median zone wise :- "+median);

            } else if (type.equalsIgnoreCase("commissary")) {  // cus2a
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2b_CommissonaryWise(month_date,zone_code);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2b_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
                ...
                System.out.println("cus 2b median commi wise :- "+median);
            }else if (type.equalsIgnoreCase("all_commissary")) {  // cus2b
                //              '" + month_date + "'	 '" + prev_month_new + "'	'" + zone_code + "'		'" + come_name + "' 	'" + next_month_new + "'
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2b_AllCommissonaryWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2b_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
    ...
    public Object Custom2c(@RequestParam String month_date,@RequestParam String type, @RequestParam(required = false) String zone_code){
        ...
        try {
            ...
            if (type.equalsIgnoreCase("zone")) {
                //              '" + month_date + "'	 '" + prev_month_new + "'	'" + zone_code + "'		'" + come_name + "' 	'" + next_month_new + "'
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2c_ZoneWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
...
//                    double col16=rsGst14aa.getDouble("col16");
                ...
                System.out.println("cus 2c median zone wise :- "+median);

            } else if (type.equalsIgnoreCase("commissary")) {  // cus2c
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2c_CommissonaryWise(month_date,zone_code);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2c_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
...
//                    double col16=rsGst14aa.getDouble("col16");
                ...
                System.out.println("cus 2c median commi wise :- "+median);
            }else if (type.equalsIgnoreCase("all_commissary")) {  // cus2c
                //              '" + month_date + "'	 '" + prev_month_new + "'	'" + zone_code + "'		'" + come_name + "' 	'" + next_month_new + "'
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus2c_AllCommissonaryWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                while(rsGst14aa.next()) {
                    String ra= CustomRelaventAspect.cus2c_RA;
                    String zoneCode = rsGst14aa.getString("ZONE_CODE");
    ...
    public Object Custom4a(@RequestParam String month_date, @RequestParam String type, @RequestParam(required = false) String zone_code) {
        ...
        try (Connection con = JDBCConnection.getTNConnection()){
            if("zone".equalsIgnoreCase(type)) {
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4a_CommissonaryWise(month_date,zone_code);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
                    ...
                    pstmt.setString(6, month_date);
                    pstmt.setString(7, month_date);
                    pstmt.setString(8, zone_code);
                    ResultSet rsGst14aa = pstmt.executeQuery();
                    allGstaList.addAll(customSubParameterService.cus4aZoneWiseCommissionary(rsGst14aa));
                }

            }else if ("all_commissary".equalsIgnoreCase(type)) {
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4a_AllCommissonaryWise(month_date);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
    ...
    public Object Custom4b(@RequestParam String month_date, @RequestParam String type, @RequestParam(required = false) String zone_code) {
        ...
        try (Connection con = JDBCConnection.getTNConnection()){
            if("zone".equalsIgnoreCase(type)) {
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4b_CommissonaryWise(month_date,zone_code);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4b_AllCommissonaryWise(month_date);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
    ...
    public Object Custom4c(@RequestParam String month_date, @RequestParam String type, @RequestParam(required = false) String zone_code) {
        ...
        try (Connection con = JDBCConnection.getTNConnection()){
            if("zone".equalsIgnoreCase(type)) {
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4c_CommissonaryWise(month_date,zone_code);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4c_AllCommissonaryWise(month_date);
                try (PreparedStatement pstmt = con.prepareStatement(queryGst14aa)) {
                    pstmt.setString(1, month_date);
                    pstmt.setString(2, month_date);
                    pstmt.setString(3, month_date);
    ...
    public Object Custom4d(@RequestParam String month_date, @RequestParam String type, @RequestParam(required = false) String zone_code) {
        ...
        try {
            if (type.equalsIgnoreCase("zone")) {
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4d_CommissonaryWise(month_date, zone_code);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
                ...
                String queryGst14aa = new CustomSubParameterWiseQuery().QueryFor_cus4d_AllCommissonaryWise(month_date);
                ResultSet rsGst14aa = GetExecutionSQL.getResult(queryGst14aa);
