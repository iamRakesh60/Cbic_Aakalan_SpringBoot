...
//                    }
    ...
    public  List<GSTCUS> gst7Zone(ResultSet rsGst14aa) throws SQLException {
        ...
        while(rsGst14aa.next()) {
            ...
            int col22ab = rsGst14aa.getInt("col22");
            int col16ab = rsGst14aa.getInt("col16");
...
//            int col23=rsGst14aa.getInt("col23");
    ...
    public  List<GSTCUS> gst10aZone(ResultSet rsGst14aa) throws SQLException {
        ...
        while(rsGst14aa.next()) {
            ...
            Double t_score = rsGst14aa.getDouble("total_score");
             median = rsGst14aa.getDouble("median_col6");
            Double numerator_3a = rsGst14aa.getDouble("col6");
            // int Zonal_rank = 0;
            //  String gst = "no";
            // int way_to_grade = 0;
    ...
    public  List<GSTCUS> gst11aZone(ResultSet rsGst14aa) throws SQLException {
        ...
        while(rsGst14aa.next()) {
            ...
            total = rsGst14aa.getDouble("total_score")*100;
             median = rsGst14aa.getDouble("median_11a");
    ...
    public  List<GSTCUS> gst11bZone(ResultSet rsGst14aa) throws SQLException {
        ...
        while(rsGst14aa.next()) {
            ...
            String zoneCode = rsGst14aa.getString("ZONE_CODE");
            String commname="ALL";
            int col10A = rsGst14aa.getInt("col10A");
            int col12A = rsGst14aa.getInt("col12A");
            int col10B = rsGst14aa.getInt("col10B");
            int col12B = rsGst14aa.getInt("col12B");
            int Zonal_rank = 0;
            String gst = "no";
            //int way_to_grade = 0;
            int insentavization = 0;
            //int sub_parameter_weighted_average = 0;
            int numerator = rsGst14aa.getInt("numerator");
            int denominator = rsGst14aa.getInt("denominator");
    ...
    public  List<GSTCUS> gst11cZone(ResultSet rsGst14aa) throws SQLException {
        ...
        while(rsGst14aa.next()) {
            ...
            // double t_score = rsGst14aa.getDouble("total_score") * 100;
            total = rsGst14aa.getDouble("total_score")*100;
             median = rsGst14aa.getDouble("median_11c");
            int col_10=rsGst14aa.getInt("col10");
            int col_4=rsGst14aa.getInt("col4");
