...
public class RelevantAspect {
    ...
    public static final String GST4D_RA ="Recoveries made upto the month vis-a-vis detections upto the month";
    ...
    public static final String GST8A_RA ="Amount of Recoverable arrears recovered during the month vis-à-vis pro rata target given upto the month for the formation (Zone/Commissionerate)";
    public static final String GST8B_RA ="Recoverable arrears pending for more than one year vis-à-vis total recoverable arrears pending  ";
    public static final String GST9A_RA ="Number of cases where prosecution was not launched within 2 months of prosecution sanction date vis-à-vis total number of prosecution sanctioned cases ";
    public static final String GST9B_RA ="Number of Prosecution launched upto the month vis-à-vis  number of arrests made upto the month";
